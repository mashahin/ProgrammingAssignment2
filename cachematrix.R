...
## following two functions are used to compute/cache the inverse of a matrix.
...
# computation. Otherwise, it computes the inverse qnd sets the value in the cache.
